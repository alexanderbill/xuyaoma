...
connection.query(
    ...
    'created DATETIME, '+
    'remainNum VARCHAR(255), '+
    'address VARCHAR(255), '+
    'courses VARCHAR(255), '+
    'district_ids VARCHAR(255), '+
    'trainingmethod VARCHAR(255), '+
    'FWAreaValueMax VARCHAR(255), '+
    'title VARCHAR(255), '+
    'helloimage VARCHAR(255), '+
...
var selectYaoDB = function(query, res){
    connection.query('SELECT * FROM ' + DATABASE, function(err, result){
      debugger;
      var str = {};
      var index = 0;
